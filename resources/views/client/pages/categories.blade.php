...
@section("title", "VnExpress - ".Str::title(Str::slug($categories, " ")))
@section("content")
    <div class="row">
        <div class="col-sm-12">
            <div class="text-center">
                <h1 class="text-center mt-5">
                    {{Str::title(Str::slug($categories, " "))}}
                </h1>
                <p class="text-secondary fs-15">
                    Chuyên Mục
                </p>
            </div>
{{--            <h5 class="text-muted font-weight-medium mb-3">{{Str::title(Str::slug($categories, " "))}}</h5>--}}
        </div>
    </div>
{{--    <div class="row">--}}
